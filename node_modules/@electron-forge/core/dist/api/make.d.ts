...
export declare const listrMake: (childTrace: typeof autoTrace, { dir: providedDir, interactive, skipPackage, arch, platform, overrideTargets, outDir, }: MakeOptions, receiveMakeResults?: ((results: ForgeMakeResult[]) => void) | undefined) => Listr<MakeContext, "default", "verbose">;
