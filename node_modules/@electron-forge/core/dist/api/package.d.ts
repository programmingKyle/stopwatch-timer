...
export declare const listrPackage: (childTrace: typeof autoTrace, { dir: providedDir, interactive, arch, platform, outDir, }: PackageOptions) => Listr<PackageContext, "default", "verbose">;
