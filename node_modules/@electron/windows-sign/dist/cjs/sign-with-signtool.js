...
async function signWithSignTool(options) {
    ...
    const signToolPath = options.signToolPath || process.env.WINDOWS_SIGNTOOL_PATH || path_1.default.join(__dirname, '../../vendor/signtool.exe');
...
//# sourceMappingURL=sign-with-signtool.js.map